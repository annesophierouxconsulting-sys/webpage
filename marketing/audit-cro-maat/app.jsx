      ...
      <div className="binome-stage">
        <div className="binome-grid reveal-list">
          ...
          <div className="binome-card right reveal-item">
            ...
            <p className="binome-desc">Spécialiste CRO avec un historique de missions sur des sites e-commerce, SaaS et leadgen à fort trafic (+130 marques accompagnées). Expert en recherche utilisateur et en expérimentation, il conçoit des protocoles de test rigoureux pour générer des apprentissages fiables et actionnables. Il forme également au CRO et diffuse des méthodes éprouvées (+1200 personnes formées).</p>
            <div className="binome-tags">
              <span className="binome-tag">CRO</span>
